...
require('lazy').setup({
  ...
  --  The configuration is done below. Search for lspconfig to find it below.
  {
    ...
    dependencies = {
      ...
      { 'williamboman/mason.nvim', config = true, keys = { { "<leader>cm", "<cmd>Mason<cr>", desc = "Mason" } } },
  ...
  -- Nicer UI for diagnostics, references, telescope results
  {
    "folke/trouble.nvim",
...
-- Custom project_files function to search in git root if inside a git repository
...
vim.keymap.set('n', '<leader><space>', project_files, { desc = 'Search project files' })
